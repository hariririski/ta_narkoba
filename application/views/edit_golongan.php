            ...
            <div class="container">
			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
						...
						<?php foreach($edit_golongan as $data){ ?>
                        <?php echo $this->session->flashdata('pesan');?>
						 <?php
							echo form_open('Redirect_controller/proses_edit_golongan?id='.$data->id_golongan.'');    
						?>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Nama Golongan</label>
                                            <input type="text" value="<?php echo $data->nama_golongan; ?>" class="form-control" id="firstname" name="nama_golongan" required>
                                        </div>
                                    </div>
