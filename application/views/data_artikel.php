                                ...
                                <tbody>
								 <?php echo $this->load->view('common/modal', '', TRUE);?>
                                    ...
                                    <tr class="odd gradeX">
										...
										<td><a href="<?php echo base_url()?>edit_artikel?id=<?php echo $data->id_artikel?>"  ><button type="button" class="btn btn-success">Edit</button></a></td>
										<?php
										echo"<td class='center'><a href='". base_url()."Redirect_controller/proses_hapus_artikel/".$data->id_artikel."' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?') \" title='Hapus'><button type='button' class='btn btn-danger'>Hapus</button></a>
										</td>";
										?>
