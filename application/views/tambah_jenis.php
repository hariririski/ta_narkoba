			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        ...
                        <?php echo $this->session->flashdata('pesan');?>
						 <?php
							echo form_open('Redirect_controller/proses_tambah_jenis');    
						?>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Nama Jenis Narkoba</label>
                                            <input type="text" class="form-control" id="hero-demo" name="nama_jenis">
                                        </div>
                                    </div>
        ...
        $(function(){
            $('#hero-demo').autoComplete({
                ...
                source: function(term, suggest){
                    ...
                    var choices = [ <?php foreach($data_jenis as $auto){ echo "'";
																		 echo $auto->nama_jenis;
																		 echo "'";
																		 echo","; }  ?> 'Tidak Ada'];
                    var suggestions = [];
