			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        ...
                        <div class="box clearfix">
                            <div class="heading">
                                <h3 class="text-uppercase">Tambah Jenis Narkoba</h3>
                            </div>
						<?php foreach($edit_jenis as $data){ ?>
                        <?php echo $this->session->flashdata('pesan');?>
						 <?php
							echo form_open('Redirect_controller/proses_edit_jenis?id='.$data->id_jenis.'');    
						?> 
						
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Nama Jenis Narkoba</label>
                                            <input type="text" class="form-control" value="<?php echo $data->nama_jenis; ?>"id="firstname" name="nama_jenis">
                                        </div>
                                    </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
										...
										<td><a href="<?php echo base_url()?>edit_jenis?id=<?php echo $data->id_jenis?>" ><button type="button" class="btn btn-success">Edit</button></a></td>
										<?php
										echo"<td class='center'><a href='". base_url()."Redirect_controller/proses_hapus_jenis/".$data->id_jenis."' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?') \" title='Hapus'><button type='button' class='btn btn-danger'>Hapus</button></a>
										</td>";
										?>
